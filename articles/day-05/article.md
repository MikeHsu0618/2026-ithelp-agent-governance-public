...
![Agent action path 由 Caller 經 Agent Runtime 與 Policy Checkpoint 到 Tool／Resource。四個治理問題分別補上 principal 與 delegation、artifact 版本與信任、policy decision，以及可重建的執行證據。](https://raw.githubusercontent.com/MikeHsu0618/2026-ithelp-agent-governance-public/day-14/assets/diagrams/day-05/reference-architecture-v0.1.png)
...
我把目前的 evidence 填進 [Agent Governance 四問 Checklist](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-14/articles/day-05/governance-four-question-checklist.md)：
