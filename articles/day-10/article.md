...
![值班工程師的入口 Token 到了 Observability MCP。嚴格檢查 audience 時拒絕。改讓下游接受入口 audience 時雖能通過，Audit 卻只剩 Human。另一條路改用下游專用 Token 和 Delegation Context。](https://raw.githubusercontent.com/MikeHsu0618/2026-ithelp-agent-governance-public/day-10-r4/assets/diagrams/day-10/passthrough-vs-bound-token.png)
...
完整的離線對照與重跑指令留在 [Lab 02](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-10-r4/labs/02-identity-boundary/README.md) 和 [Day 10 evidence](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-10-r4/assets/screenshots/day-10/evidence.md)。[Token Passthrough Audit Reading Guide](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-10-r4/articles/day-10/token-passthrough-audit-guide.md) 可用來比較兩條 `ALLOW` 路徑的 Audit。下圖呈現七組合成請求的結果。讀者可先看嚴格 audience 拒絕、共用 audience 放行但歸屬消失、下游專用 Token 與 Context 保留責任鏈這三組。

![Day 10 的七組實際 CLI 結果。入口 Token 在自己的 resource 通過，下游嚴格驗 audience 時拒絕。共用 audience 雖通過但只剩 Human 歸屬，下游專用 Token 加 Context 才保留完整責任鏈。](https://raw.githubusercontent.com/MikeHsu0618/2026-ithelp-agent-governance-public/day-10-r4/assets/screenshots/day-10/01-passthrough-results.png)
