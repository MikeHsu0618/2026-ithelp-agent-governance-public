...
下表是目前的摘要。完整版本另外列出 owner、upgrade／fork surface、remaining gap 與 reopen condition，放在 [Agent Governance Capability Ledger](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-28/articles/day-27/capability-ledger.md)。要匯入試算表或改成自己的架構，可以直接下載 [CSV 版本](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-28/articles/day-27/capability-ledger.csv)。
