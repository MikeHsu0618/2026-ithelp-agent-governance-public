...
這篇沿同一筆 Action 建立 [Production Responsibility Contract](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-07-r1/articles/day-29/production-responsibility-contract.md)，把 Control Owner、Decision Owner、Handoff Evidence、Escalation 與 Residual Risk 放回執行順序裡。
...
責任審查若只列「模型幻覺、資安、法規、擴充性」，很難決定是否上線。本文的 [Residual Risk Register](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-07-r1/articles/day-29/residual-risk-register.md) 只收前文已經出現的六項缺口：
