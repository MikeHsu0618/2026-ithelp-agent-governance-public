...
[Day 27 的 Capability Ledger](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-23-r1/articles/day-27/capability-ledger.md) 同時留下 `KEEP`、`ADOPT`、`DEFER` 與 `UNKNOWN`。只看風險，最刺眼的 `UNKNOWN` 好像應該優先處理。照產品架構圖走，又很容易先裝 kagent、Registry 或另一套 Identity Center。這兩種排序都忽略同一件事：誰現在有能力把新增控制接進值班、升級和事故流程？
...
完整版本放在 [Agent Governance Adoption Trigger Matrix](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-23-r1/articles/day-28/adoption-trigger-matrix.md)。正文保留最常見的八種情境：
