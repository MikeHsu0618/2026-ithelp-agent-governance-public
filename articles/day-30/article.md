...
Day 3 用相同輸入做了放行與拒絕對照：換成 Tool Allowlist 後，危險 Function 沒有執行，Agent 仍改用 `query_metrics` 完成唯讀調查。這筆對照的回放資料留在 [Incident Replay Lab](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-16-r4/labs/05-incident-replay/README.md)。
