...
完整事件與回放資料留在 [Incident Replay Lab](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-05-r2/labs/05-incident-replay/README.md)。對下一筆真的有副作用的 action，架構還得補上可信身分、delegation、實際執行的 Artifact 與業務授權。執行後也要留下能對回同一筆 action 的 effect receipt。
