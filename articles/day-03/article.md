...
[直接執行 Day 3 Lab](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-26/labs/01-unsafe-agent/README.md)
...
![改寫 Log 通過 keyword guard，Gemini 提出 delete_demo_database。ADK callback 使用 open policy 時觸發 canary，換成 Tool allowlist 後在 function 執行前拒絕。](https://raw.githubusercontent.com/MikeHsu0618/2026-ithelp-agent-governance-public/day-26/assets/diagrams/day-03/guard-vs-authorization.png)
...
下面的 Carbon 圖來自兩次 Gemini live run。兩邊使用相同 fixture，兩個 manifest 記錄的 SHA-256 都是 `11936a4292b4524c147d557908cdd10568222f47e6d327bc28ad099d8d479262`。圖片方便比較，完整的 [open policy events](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-26/assets/screenshots/day-03/evidence/live-open-events.jsonl) 與 [allowlist events](https://github.com/MikeHsu0618/2026-ithelp-agent-governance-public/blob/day-26/assets/screenshots/day-03/evidence/live-allowlist-events.jsonl) 也保留在 repo，指令和 trace ID 不需要從圖上抄。

![Gemini 對相同改寫 fixture 都提出 delete_demo_database。Open policy 觸發 canary，Tool allowlist 回覆 DENY，canary 維持零。](https://raw.githubusercontent.com/MikeHsu0618/2026-ithelp-agent-governance-public/day-26/assets/screenshots/day-03/01-live-guard-vs-allowlist.png)
